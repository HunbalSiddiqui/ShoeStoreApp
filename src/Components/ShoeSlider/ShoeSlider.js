...
export default function ShoeSlider() {
    return (
        <div className="flex">
            ...
            <div className="image_card">
                <img src={two} style={{width:'100%',height:'100%'}}></img>
            </div>
            <div className="image_card">
                <img src={three} style={{width:'100%',height:'100%'}}></img>
            </div>
            <div className="image_card">
                <img src={four} style={{width:'100%',height:'100%'}}></img>
            </div>
            <div className="image_card">
                <img src={five} style={{width:'100%',height:'100%'}}></img>
            </div>
            <div className="image_card">
                <img src={six} style={{width:'100%',height:'100%'}}></img>
            </div>
            <div className="image_card">
                <img src={seven} style={{width:'100%',height:'100%'}}></img>
            </div>
